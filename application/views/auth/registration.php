                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?=base_url('Auth/registration');?>">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="email" id="email" value="<?=set_value('email')?>"
                                        placeholder="Email Address">
                                        <?= form_error('email','<small class="text-danger pl-3">','</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" name="phone" id="phone"  value="<?=set_value('phone')?>"
